...
odoo.define('backend_theme_v11.Sidebar', function(require) {
	...
	(function($) {
	    ...
	    $("#app-sidebar-close").on('click', function() {
	        document.getElementById("app-sidebar").style.display = "none";
	        document.getElementById("app-sidebar-hide").style.display = "block"
        });
        $("#app-sidebar-open").on('click', function() {
	        document.getElementById("app-sidebar").style.display = "block";
	        document.getElementById("app-sidebar-hide").style.display = "none"
        });
