...
class AbstractReportXslx(ReportXlsx):
    ...
    def write_line(self, line_object):
        ...
        for col_pos, column in self.columns.iteritems():
            ...
            balance_amount = 0.0
            if cell_type == 'amount_1':
                balance_amount = line_object.debit - line_object.credit
                if line_object.account_id and line_object.account_id.user_type_id and line_object.account_id.user_type_id.include_initial_balance:
                    balance_amount = line_object.initial_balance + line_object.debit - line_object.credit
            if cell_type == 'string':
            ...
            elif cell_type == 'amount_1':
                self.sheet.write_number(
                    self.row_pos, col_pos, balance_amount, self.format_amount
                )
        self.row_pos += 1
