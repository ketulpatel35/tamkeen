...
class TrialBalanceXslx(abstract_report_xlsx.AbstractReportXslx):
    ...
    def _get_report_filters(self, report):
        return [
            ...
            [_('Hide Accounts/Initial Balance'),
                str(report.hide_pl_account) + "/" + str(report.include_initial_balance)],
            [_('Report As Year to Date Or Period to date'),
                report.include_initial_balance and _('YTD') or _('PTD')]
        ]
