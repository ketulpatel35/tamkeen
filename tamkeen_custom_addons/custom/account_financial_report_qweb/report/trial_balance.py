...
class TrialBalanceReport(models.TransientModel):
    ...
    *** TrialBalanceReportPartner
    ...
    display_all_accounts = fields.Boolean()
...
FROM
    account_account acc
WHERE
    id not in (select account_id from report_general_ledger_qweb_account
    acc_rag WHERE acc_rag.report_id = %s)
            """
