...
class AgedPartnerBalanceReport(models.TransientModel):
    ...
    **** AgedPartnerBalanceReportLine
    ...
    _name = 'report_aged_partner_balance_partner_qweb'
    ...
    account_ids = fields.One2many(
        comodel_name='report_aged_partner_balance_partner_qweb_account',
...
class AgedPartnerBalanceReportAccount(models.TransientModel):
    ...
    _name = 'report_aged_partner_balance_partner_qweb_account'
    _order = 'code ASC'

    report_id = fields.Many2one(
        comodel_name='report_aged_partner_balance_partner_qweb',
        ondelete='cascade',
        index=True
    )
    ...
    partner_ids = fields.One2many(
        comodel_name='report_aged_partner_balance_partner_qweb_partner',
...
class AgedPartnerBalanceReportPartner(models.TransientModel):
    ...
    _name = 'report_aged_partner_balance_partner_qweb_partner'
    ...
    move_line_ids = fields.One2many(
        comodel_name='report_aged_partner_balance_partner_qweb_move_line',
        inverse_name='report_partner_id'
    )
    line_ids = fields.One2many(
        comodel_name='report_aged_partner_balance_partner_qweb_line',
        inverse_name='report_partner_id'
    )
...
ORDER BY
    CASE
        WHEN
            "report_aged_partner_balance_partner_qweb_partner"."partner_id" IS NOT NULL
        THEN 0
        ELSE 1
    END,
    "report_aged_partner_balance_partner_qweb_partner"."name"
        """


class AgedPartnerBalanceReportLine(models.TransientModel):

    _name = 'report_aged_partner_balance_partner_qweb_line'
...
class AgedPartnerBalanceReportMoveLine(models.TransientModel):
    ...
    _name = 'report_aged_partner_balance_partner_qweb_move_line'
...
class AgedPartnerBalanceReportCompute(models.TransientModel):
    ...
    _inherit = 'report_aged_partner_balance_partner_qweb'
    ...
    def print_report(self, xlsx_report=False):
        ...
        if xlsx_report:
            report_name = 'account_financial_report_qweb.' \
                          'report_aged_partner_balance_with_partner_xlsx'
    ...
    def _inject_account_values(self):
        """Inject report values for report_aged_partner_balance_partner_qweb_account"""
        query_inject_account = """
INSERT INTO
    report_aged_partner_balance_partner_qweb_account
    (
    report_id,
    create_uid,
    create_date,
...
WHERE
    ...
    def _inject_partner_values(self):
        """Inject report values for report_aged_partner_balance_partner_qweb_partner"""
        query_inject_partner = """
INSERT INTO
    report_aged_partner_balance_partner_qweb_partner
    (
    report_account_id,
    create_uid,
    create_date,
...
INNER JOIN
    report_aged_partner_balance_partner_qweb_account ra ON rao.code = ra.code
WHERE
    rao.report_id = %s
AND ra.report_id = %s
        """
    ...
    def _inject_line_values(self, only_empty_partner_line=False):
        """ Inject report values for report_aged_partner_balance_partner_qweb_line.
    ...
    date_range AS
        (
            SELECT
                ...
                DATE %s - INTEGER '360' AS date_older
        )
INSERT INTO
    report_aged_partner_balance_partner_qweb_line
    (
        report_partner_id,
        create_uid,
        create_date,
    ...
    SUM(
        CASE
            WHEN
                ...
                AND rlo.date_due <= date_range.date_less_360_days
            THEN rlo.amount_residual
        END
    ) AS age_360_days,
    SUM(
...
INNER JOIN
    report_aged_partner_balance_partner_qweb_account ra ON rao.code = ra.code
INNER JOIN
    report_aged_partner_balance_partner_qweb_partner rp
        ON
...
GROUP BY
    rp.id
        """
        query_inject_line_params = (self.date_at,) * 8
    ...
    def _inject_move_line_values(self, only_empty_partner_line=False):
        """ Inject report values for report_aged_partner_balance_partner_qweb_move_line
...
INSERT INTO
    report_aged_partner_balance_partner_qweb_move_line
    (
        report_partner_id,
        create_uid,
        create_date,
...
WITH
    cumuls AS
        (
            ...
            FROM
                report_aged_partner_balance_partner_qweb_line rl
            INNER JOIN
                report_aged_partner_balance_partner_qweb_partner rp
                    ON rl.report_partner_id = rp.id
            INNER JOIN
                report_aged_partner_balance_partner_qweb_account ra
